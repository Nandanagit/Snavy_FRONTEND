...
// import { apiClient } from "../../types/axios"; // unused
import { useRouter } from "next/navigation";
import { FiArrowRight, FiGlobe } from "react-icons/fi";

export default function Home() {
  // const [url] = useState(""); // unused
  // const [error, setError] = useState(""); // unused
  // const [loading, setLoading] = useState(false); // unused
  // const [data, setData] = useState<{ message?: string } | null>(null); // unused
  const [username, setName] = useState("");
  const [password, setPassword] = useState("");
  const router = useRouter();

  // const handleGenerate = async () => { // unused function
  //   if (!url) {
  ...
  //     toast.error(error);
  //   }
  // }, [error]); // commented out since error is unused
  ...
  //   }
  // }, [data, router]); // commented out since data is unused
